...
require (
	github.com/TykTechnologies/tyk v1.9.2-0.20221013115745-8f986f0d0b6f
...
require (
	...
	github.com/TykTechnologies/graphql-go-tools v1.6.2-0.20221012143123-be910dea323d // indirect
