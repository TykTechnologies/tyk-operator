module github.com/TykTechnologies/tyk-operator/bdd/grpc_plugin

go 1.14

require (
	github.com/TykTechnologies/gojsonschema v0.0.0-20170222154038-dcb3e4bb7990 // indirect
	github.com/TykTechnologies/tyk v2.9.4+incompatible // indirect
	github.com/TykTechnologies/tyk-protobuf v0.0.0-20200408093832-b2409f0d2672
