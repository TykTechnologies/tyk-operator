...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinkedPolicies) DeepCopyInto(out *LinkedPolicies) {
	*out = *in
	if in.From != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinkedPolicies.
func (in *LinkedPolicies) DeepCopy() *LinkedPolicies {
	if in == nil {
		return nil
	}
	out := new(LinkedPolicies)
	in.DeepCopyInto(out)
	return out
}
