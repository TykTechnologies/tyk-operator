...
func (in *ApiDefinitionStatus) DeepCopyInto(out *ApiDefinitionStatus) {
	*out = *in
	...
	if in.LinkedByAPI != nil {
		in, out := &in.LinkedByAPI, &out.LinkedByAPI
		*out = make([]Target, len(*in))
		copy(*out, *in)
	}
	if in.LinkedToAPI != nil {
		in, out := &in.LinkedToAPI, &out.LinkedToAPI
		*out = make([]Target, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoopInternal) DeepCopyInto(out *LoopInternal) {
	*out = *in
	out.Target = in.Target
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoopInternal.
func (in *LoopInternal) DeepCopy() *LoopInternal {
	if in == nil {
		return nil
	}
	out := new(LoopInternal)
	in.DeepCopyInto(out)
	return out
}
