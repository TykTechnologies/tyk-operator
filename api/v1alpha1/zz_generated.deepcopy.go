...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GraphQLRef) DeepCopyInto(out *GraphQLRef) {
	*out = *in
	out.SubGraphRef = in.SubGraphRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GraphQLRef.
func (in *GraphQLRef) DeepCopy() *GraphQLRef {
	if in == nil {
		return nil
	}
	out := new(GraphQLRef)
...
func (in *Refs) DeepCopyInto(out *Refs) {
	*out = *in
	...
	if in.PinnedPublicKey != nil {
		in, out := &in.PinnedPublicKey, &out.PinnedPublicKey
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.UpstreamCertificate != nil {
		in, out := &in.UpstreamCertificate, &out.UpstreamCertificate
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubGraphRef) DeepCopyInto(out *SubGraphRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubGraphRef.
func (in *SubGraphRef) DeepCopy() *SubGraphRef {
	if in == nil {
		return nil
	}
	out := new(SubGraphRef)
