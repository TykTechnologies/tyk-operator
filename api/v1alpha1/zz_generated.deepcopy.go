...
func (in *APIDefinitionSpec) DeepCopyInto(out *APIDefinitionSpec) {
	*out = *in
	...
	if in.VersionDefinition != nil {
		in, out := &in.VersionDefinition, &out.VersionDefinition
		*out = new(VersionDefinition)
		**out = **in
	}
	if in.VersionData != nil {
		in, out := &in.VersionData, &out.VersionData
		*out = new(VersionData)
		(*in).DeepCopyInto(*out)
	}
	if in.CustomMiddleware != nil {
		in, out := &in.CustomMiddleware, &out.CustomMiddleware
