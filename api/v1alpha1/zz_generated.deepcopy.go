...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubGraphReference) DeepCopyInto(out *SubGraphReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubGraphReference.
func (in *SubGraphReference) DeepCopy() *SubGraphReference {
	if in == nil {
		return nil
	}
	out := new(SubGraphReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SuperGraphSpec) DeepCopyInto(out *SuperGraphSpec) {
	*out = *in
	if in.SubgraphsRefs != nil {
		...
		*out = make([]SubGraphReference, len(*in))
		copy(*out, *in)
	}
}
