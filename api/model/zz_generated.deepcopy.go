...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GraphQLSubgraphEntityRefs) DeepCopyInto(out *GraphQLSubgraphEntityRefs) {
	*out = *in
	if in.Headers != nil {
		in, out := &in.Headers, &out.Headers
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GraphQLSubgraphEntityRefs.
func (in *GraphQLSubgraphEntityRefs) DeepCopy() *GraphQLSubgraphEntityRefs {
	if in == nil {
		return nil
	}
	out := new(GraphQLSubgraphEntityRefs)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GraphQLSupergraphConfig) DeepCopyInto(out *GraphQLSupergraphConfig) {
	*out = *in
	...
	if in.SubgraphsRefs != nil {
		in, out := &in.SubgraphsRefs, &out.SubgraphsRefs
		*out = make([]GraphQLSubgraphEntityRefs, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
