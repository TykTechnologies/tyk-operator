...
func (in *APIDefinitionSpec) DeepCopyInto(out *APIDefinitionSpec) {
	*out = *in
	...
	if in.PinnedPublicKeysSecretNames != nil {
		...
		*out = make(map[string]PinnedPublicKeySecret, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PinnedPublicKeySecret) DeepCopyInto(out *PinnedPublicKeySecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PinnedPublicKeySecret.
func (in *PinnedPublicKeySecret) DeepCopy() *PinnedPublicKeySecret {
	if in == nil {
		return nil
	}
	out := new(PinnedPublicKeySecret)
	in.DeepCopyInto(out)
	return out
}
