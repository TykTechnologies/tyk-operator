...
func (in *APIDefinitionSpec) DeepCopyInto(out *APIDefinitionSpec) {
	*out = *in
	in.TykApiDefinition.DeepCopyInto(&out.TykApiDefinition)
...
func (in *ExtendedPathsSet) DeepCopyInto(out *ExtendedPathsSet) {
	*out = *in
	in.ExtendedPathsSet.DeepCopyInto(&out.ExtendedPathsSet)
...
func (in *GraphQLConfig) DeepCopyInto(out *GraphQLConfig) {
	*out = *in
	in.GraphQLConfig.DeepCopyInto(&out.GraphQLConfig)
}
...
func (in *RoutingTrigger) DeepCopyInto(out *RoutingTrigger) {
	*out = *in
	in.RoutingTrigger.DeepCopyInto(&out.RoutingTrigger)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TykApiDefinition) DeepCopyInto(out *TykApiDefinition) {
	*out = *in
	in.ExpirationTs.DeepCopyInto(&out.ExpirationTs)
	in.ExternalOAuth.DeepCopyInto(&out.ExternalOAuth)
	in.OpenIDOptions.DeepCopyInto(&out.OpenIDOptions)
	in.Oauth2Meta.DeepCopyInto(&out.Oauth2Meta)
	out.Auth = in.Auth
	if in.AuthConfigs != nil {
		in, out := &in.AuthConfigs, &out.AuthConfigs
		*out = make(map[string]apidef.AuthConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	...
	out.NotificationsDetails = in.NotificationsDetails
	if in.HmacAllowedAlgorithms != nil {
		in, out := &in.HmacAllowedAlgorithms, &out.HmacAllowedAlgorithms
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	in.RequestSigning.DeepCopyInto(&out.RequestSigning)
	in.VersionDefinition.DeepCopyInto(&out.VersionDefinition)
	in.VersionData.DeepCopyInto(&out.VersionData)
	in.UptimeTests.DeepCopyInto(&out.UptimeTests)
	in.Proxy.DeepCopyInto(&out.Proxy)
	in.CustomMiddleware.DeepCopyInto(&out.CustomMiddleware)
	in.CacheOptions.DeepCopyInto(&out.CacheOptions)
	in.AuthProvider.DeepCopyInto(&out.AuthProvider)
	in.SessionProvider.DeepCopyInto(&out.SessionProvider)
	in.EventHandlers.DeepCopyInto(&out.EventHandlers)
	...
	if in.ResponseProcessors != nil {
		...
		*out = make([]apidef.ResponseProcessor, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TykApiDefinition.
func (in *TykApiDefinition) DeepCopy() *TykApiDefinition {
	if in == nil {
		return nil
	}
	out := new(TykApiDefinition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *URLRewriteMeta) DeepCopyInto(out *URLRewriteMeta) {
	*out = *in
	in.URLRewriteMeta.DeepCopyInto(&out.URLRewriteMeta)
	if in.Triggers != nil {
